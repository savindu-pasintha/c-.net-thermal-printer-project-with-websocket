  ...
  <body>
    ...
    <!--IMPORTANT: BE SURE YOU HONOR THIS JS LOAD ORDER
      <script src="scripts/zip-full.min.js"></script>
        <script src="scripts/JSESCPOSBuilder.js"></script>
        ...
        if (jspmWSStatus()) {
          ...
          escpos.ESCPOSImage.load(
            ...
            var escposCommands = doc
              ...
              .text('العربية', 28596) //arabic

              .align(escpos.TextAlignment.Left)
              .linearBarcode(
                '1234567',
                escpos.Barcode1DType.EAN8,
                new escpos.Barcode1DOptions(
                  2,
                  100,
                  true,
                  escpos.BarcodeTextPosition.Below,
                  escpos.BarcodeFont.A,
                ),
              )
              ...
              .qrCode(
                'https://mycompany.com',
                new escpos.BarcodeQROptions(escpos.QRLevel.L, 6),
              )
              .feed(5)
              .cut()
              .generateUInt8Array()
            ...
            .text(
              ...
              .text(
                '你好! Luís argüia à Júlia que «brações, fé, chá, óxido, pôr, zângão» eram palavras do português.',
                1252,
              ) // Portuguese
              .text(
            ...
            .pdf417(
                'PDF417 data to be encoded here',
                new escpos.BarcodePDF417Options(3, 3, 0, 0.1, false),
              )
              */
          })
        }
